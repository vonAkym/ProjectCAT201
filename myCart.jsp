...
%>
    ...
    <td><i class="fa fa-dollar-sign"></i> <%= rs.getString(10) %></td> <!-- Displaying subtotal -->
    <td><a href="removeFromCart.jsp?id=<%=rs.getString(1)%>">Remove <i class='fas fa-trash-alt'></i></a></td> <!-- Remove item link -->
</tr>
